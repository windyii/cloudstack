...
public interface NetworkService {
    ...
    IpAddress allocateIP(Account ipOwner, long zoneId, Long networkId, String ipAddress, Long vlanIds, Boolean displayIp) throws ResourceAllocationException, InsufficientAddressCapacityException,
