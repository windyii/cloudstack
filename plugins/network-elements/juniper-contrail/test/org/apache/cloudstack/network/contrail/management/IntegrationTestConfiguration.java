...
public class IntegrationTestConfiguration {
    ...
    public AffinityGroupService affinityGroupService() {
        ...
        try {
            ...
            Mockito.when(
                mock.createAffinityGroupInternal(Matchers.any(String.class), Matchers.any(Long.class), Matchers.any(Long.class), Matchers.any(String.class), Matchers.any(String.class),
